...
class HenNet_GPU():
    ...
    def build_model(self):
        ...
        span_end_encoder = Bidirectional(CuDNNGRU(int(encoding_dim/2), return_sequences=True), name='span_end_encoder1')(span_end_representation)
        span_end_encoder = Bidirectional(CuDNNGRU(int(encoding_dim/2), return_sequences=True), name='span_end_encoder2')(span_end_encoder)
